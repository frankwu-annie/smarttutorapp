    ...
    const fetchGrade = async () => {
      try {
        ...
        if (storedGrade) {
          ...
          console.log("storedGrade: ", storedGrade);
        }
      } catch (error) {
        console.error("Error fetching grade from AsyncStorage:", error);
      }
    };
    fetchGrade();
  }, []);
  ...
  useEffect(() => {
    const saveGrade = async () => {
      try {
        ...
        console.log("storedGrade: ", selectedGrade);
      } catch (error) {
        console.error("Error saving grade to AsyncStorage:", error);
      }
    };
    saveGrade();
  }, [selectedGrade]);
